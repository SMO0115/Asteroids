...
namespace Game {
    ...
    bool Asteroids::init(Engine::Application &engine) {
...

        {
            ...
            UI_Score->addComponent<Engine::Graphics::UITextComponent>(
                "Score: " + std::to_string(0),
                std::move(font),
                Engine::Core::Color{255, 255, 255}, 20, 10
                );
        ...
        }
        {
            ...
            Engine::Assets::Font* font = asset_manager.getFont("pixel",24);
            UI_Lives->addComponent<Engine::Graphics::UITextComponent>(
                "Lives: " + std::to_string(0),
                std::move(font),
                Engine::Core::Color{255, 255, 255}, 690, 10
                );
        ...
        std::array<Core::InvaderType, 5> e_enemy_types = {Core::InvaderType::INVADER_A, Core::InvaderType::INVADER_B, Core::InvaderType::INVADER_B, Core::InvaderType::INVADER_C, Core::InvaderType::INVADER_C};
        for (int i = 0; i < N; i++) {
            for (int j = 0; j < M; j++) {
    ...
    void Asteroids::render(Engine::Graphics::RenderSystem& renderer) {
