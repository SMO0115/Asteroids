...
namespace Game::Control {
    void AISystem::update(float deltaTime, Engine::Events::EngineEventBus& engine_event_bus, Events::GameEventBus& game_event_bus, std::vector<std::unique_ptr<Engine::Core::GameObject> > &game_objects) {
        ...
        for (const auto &object : game_objects) {
            ...
            switch (invader_component.type) {
                ...
                case Core::InvaderType::INVADER_A: emittor_state = Core::EmittorState::INVADER_A; break;
                case Core::InvaderType::INVADER_B: emittor_state = Core::EmittorState::INVADER_B; break;
                case Core::InvaderType::INVADER_C: emittor_state = Core::EmittorState::INVADER_C; break;
                default: emittor_state = Core::EmittorState::INVADER_A; break;
            }

            game_event_bus.publish<Events::EmitterEvent>(
                static_cast<int>( emittor_state ),
                Engine::Physics::CollisionLayer::INVADER_BULLET,
